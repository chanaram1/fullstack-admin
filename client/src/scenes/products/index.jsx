    ...
    <Card sx={{
      ...
      <CardContent>
        ...
        <Typography sx={{mb:"1.5rem"}} color={theme.palette.secondary[400]}>
          ${Number(price.toFixed(2))} {/*make it hard coded to 2 decimals*/}
        </Typography>
...
const Products = () => {
  const {data, isLoading} = useGetProductsQuery(); //grabs data from backend and checks if it has came to the front end
